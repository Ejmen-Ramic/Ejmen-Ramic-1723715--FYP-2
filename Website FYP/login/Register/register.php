...
<body>
  <main class="d-flex align-items-center min-vh-100 py-3 py-md-0">
    <div class="container">
      <a class="btn2" href="../../../Home/Home.php"><i class="fa fa-close" ></i></a>
            ...
            <div class="card-body">
              ...
              <form action="#!">
                ...
                <div class="form-group">
                  ...
                  <input type="fullname" name="fullname" id="fullname" class="form-control" placeholder="Full Name">
                </div>
                  <div class="form-group">
                ...
                <p class="login-card-footer-text">Already registered? <a href="../Login/login.html" class="text-reset">Sign in here</a></p>
