...
if (isset($_SESSION["isLogin"])) {
    ...
    echo "Thanks for registration, please login ";
...
<head>
  ...
  <title>Login</title>
  <link rel="icon" type="image/png" href="login/assets/images/tab_logo.PNG">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <form action="login.php"  method="post">
                ...
                <p class="login-card-footer-text">Don't have an account? <a href="index2.php" class="text-reset">Register here</a></p>
