...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Profile</title>
    <link rel="stylesheet" href="../database/profile/nicepage.css" media="screen">
<link rel="stylesheet" href="profile/profile.css" media="screen">
<link rel="stylesheet" href="../_reboot.scss" media="screen">

    <script class="u-script" type="text/javascript" src="../database/profile/jquery.js" defer=""></script>
    <script class="u-script" type="text/javascript" src="../database/profile/nicepage.js" defer=""></script>
...
<body class="u-body"><header class="u-clearfix u-grey-10 u-header u-header" id="sec-3d8d"><div class="u-clearfix u-sheet u-sheet-1">
      <a href="../home2/home2.php" class="u-image u-logo u-image-1" data-image-width="1323" data-image-height="445">
...
</li><li class="u-nav-item"><a class="u-button-style u-hover-palette-3-base u-nav-link u-text-active-palette-1-base u-text-hover-black" href="../database/logout.php" style="padding: 10px 20px;">👥Logout</a>
</li></ul>
        </div>
    ...
    <section>
        ...
        <img  src="../images/Home Page/leaves2.png" 
        style=
       "height: auto; 
        max-width:100%;
        " ></img>
...
<div class="id1">
    ...
    <dt><?php echo "ID: " . $_id; ?><br></dt>
    <dt><?php echo "Full Name: " . $_fullname; ?><br></dt>
    <dt><?php echo "Username: " . $_username; ?><br></dt>
    <dt><?php echo "Phone No.: " . $_phone; ?><br></dt>
    <dt><?php echo "E-mail: " . $_email; ?><br></dt>
    <dt><?php echo "Registration Date: " . $_registered; ?></dt><br>
</div>
<h4>Great, you have successfuly logged in</h4>
    <a href="#" class="button_update">Update</a>
    <a href="admins.php" class="button_admin">Admins Only</a>
...
.button_update:hover {
    ...
    <! CONTACT FORM>
    <section class="u-clearfix u-section-1" id="sec-f56d">
      ...
      <div class="u-container-style u-group u-radius-22 u-shape-round u-white u-group-1" data-animation-name="fadeIn" data-animation-duration="1000" data-animation-direction="">
