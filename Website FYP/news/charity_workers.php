...
<center>
<div class="post">
	<h4 style="float: left;"> 23/10/2021 </h4>
	<div class="post_title"><h1 style="text-align: center; margin-top: 69px;"> Charity launches appeal to support the worsening  <br> mental health of healthcare workers </h1></div>
	<br>
    <div class="post_description">JUNE marks celebrations for many across the UK as it paves the way to the end of lockdown. But for some, the impact of lockdown will continue to weigh heavy, as mental health issues have become a part of everyday life.</div>
	<div class="post_image">
		<img src="../images/IMAGES Important/related_image1.jpg "style="width:100%" >
</div>
	<div class="post_text">This has been prevalent amongst healthcare workers, as almost half of the intensive care staff in England have reported symptoms of post-traumatic stress disorder (PTSD) over the past year. The Healthcare Workers’ Foundation (HWF) is urging the public to donate to the cause this Post-Traumatic Stress Disorder Awareness Month.<br><br>
  ...
  Dr Chris George, a spokesperson for the Healthcare Workers’ Foundation and GP, has felt how hard-hitting COVID-19 has been on his colleagues and working environment.<br><br>
  
  
  <strong>He said:</strong><br><br>
 <h4>“The pandemic was a tough time for all of us, and for those working on the frontline, it was tenfold. The NHS was stretched even further than it already had been, and I saw nurses having to take care of up to three patients at once in intensive care.<br><br>
  “The mounting pressure only meant that there was sure to be aftershocks, which we are now experiencing today. Spotting signs such as intrusive thoughts or images, flashbacks, and nightmares will aid in getting yourself support quicker. We are here to help, and the therapy sessions are open to all healthcare workers who feel they need it, no matter how big or small the impact they are experiencing.”<br><br>
  You’ll be posting loads of engaging content, so be sure to keep your blog organized with Categories that also allow visitors to explore more of what interests them.</h4><br><br><br><br>
  
  <h4>HWF Response<br>_______________</h4><br>

  <strong>The HWF has started working with healthcare workers, such as an ICU Nurse in London, who has seen tremendous improvements since starting therapy sessions and said:</strong><br><br>
  
  
  “Working on the frontline took a huge mental toll on me, one that I never expected. I developed PTSD during my redeployment, and it was a lot to deal with, especially when it felt as though I was going through it alone."<br><br>
...
<div class="row_news">
	<div class="column">
		<div class="card_news">
				...
				<div class="container">
						<h3>Appeal to support mental health of healthcare workers</h3>
						<p class="title"></p>
						<p>JUNE marks celebrations for many across the UK as it paves the way to the end of lockdown. But for some, the impact of lockdown...</p>
						<p></p>
...
<div class="column">
		<div class="card_news">
				...
				<div class="container">
						...
						<p class="title"></p>
						<p>A Lebanese charity operating near the border with Syria has been working to create a self-sustaining community in...</p>
						<p></p>
