...
<link id="u-theme-google-font" rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i|Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i">
    ...
    <!-- Style CSS -->
    <link rel="stylesheet" href="../news/style_news.css">
</head>
...
<script type="application/ld+json">{
		...
		<body class="u-body"><header class="u-clearfix u-header u-header" id="sec-6015"><div class="u-clearfix u-sheet u-sheet-1">
								...
								<nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
										<div class="menu-collapse" style="font-size: 1rem; letter-spacing: 0px;">
												<a class="u-button-style u-custom-color u-custom-hover-color u-custom-left-right-menu-spacing u-custom-padding-bottom u-custom-text-active-color u-custom-text-hover-color u-custom-top-bottom-menu-spacing u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="#">
...
</li><li class="u-nav-item"><a class="u-button-style u-hover-palette-3-base u-nav-link u-text-active-palette-1-base u-text-hover-black" href="login/Login/login.php" style="padding: 10px 20px;">👥Login</a>
</li></ul>
									</div>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" style="padding: 10px 20px;">Disaster Response</a>
...
<center>
<div class="post">
	<h4 style="float: left;"> 12/11/2021 </h4>
	<div class="post_title"><h1 style="text-align: center; margin-top: 69px;"> Erskine opens £4m residential centre <br> to support transitioning vets </h1></div>
	<br>
    <div class="post_description"> SCOTLAND’S veteran’s charity, Erskine, has opened the new David Boyle Court to provide accommodation and an employability programme to support service leavers and veterans whose life or transition plans have been disrupted.</div>
	<div class="post_image">
		<img src="../images/IMAGES Important/related_image2.jpg "style="width:100%" >
</div>
	<div class="post_text">As part of this support service, Erskine will offer each resident a bespoke support package tailored to suit their needs, including volunteering, training, and work experience, as well as job opportunities with local business partners. The support aims to equip veterans with the skills to move onto sustained employment and long-term accommodation in an area of their choice.<br><br>

 The new development will support veterans who have encountered difficulties in transition. It offers them a safe place to live for up to two years, where they can learn job skills, access support services, enjoy the charity’s leading activity centre, and meet others in the same position.<br><br>
 
 Based within Erskine’s Veterans Village in Bishopton, David Boyle Court features 24 single-occupancy apartments that come fully furnished, complete with living and dining spaces, kitchen, bedroom, and an en-suite wet room. There are also four fully accessible apartments. The new facility features two communal spaces, which will be used for training, one-to-one counselling and skills development. One of these spaces will also be used as a cinema room.<br><br>
 
 Each resident will have access to all the Veterans’ Village facilities, including the Erskine Reid Macewen Activity Centre (ERMAC). ERMAC aims to enhance veterans’ quality of life and well-being in the community by providing them with an increased social network, a range of purposeful activities supported by a skilled team, and access to support services and new skills.<br><br>
 
 The Erskine Village also offers a range of other amenities, including Harry’s Café, the Royal Scots Shop, a hairdresser, and a podiatrist.”</div>
		
		<div class="post_image2">
			<img src="../images/IMAGES Important/related-image222.jpg" style="width:100%;">
	</div>

	<div class="post_text"><strong>Wing Commander Ian Cumming, Erskine Chief Executive, said:</strong> <br><br>



  “Erskine’s strength lies in the very special blend of dedicated care, compassion and understanding that we offer our residents, tenants and their families. Many of us, myself included, have served in the military, and this enhances our understanding of some of the challenges they face.<br><br>
  
  
  “David Boyle Court is just the latest project in a lifetime of tireless work aimed at providing support and care to veterans. Veterans have a great deal to offer civilian society, and most transition seamlessly. However, like most people who change career, they need support and new skills to help with the transition. This project will give them time and space to get the best possible support to develop and showcase their talents as they re-prepare for civilian life. This significant investment signals an exciting chapter for the charity and a bright future for our veterans. <br><br>
  
  
  “We agree with the Scottish Veterans Commissioner’s ‘Positive Futures‘ report, which states that our Service leavers and Veterans have much to offer employers and their communities in Scotland. They are a source of talent that we cannot afford to overlook. We must ensure that those who have served their country are never overlooked. Erskine will give them the best possible chance to become not simply successful veterans, but successful citizens – living and working in the communities of their choice.” <br><br>
  
  Erskine will be working with multiple partners to deliver these Employability Support Packages, including Barclays Veterans’ Employment Transition Support (VETS), OCS, Walking With The Wounded, Poppyscotland and Buildforce. The charity will also work closely with The MOD’s Defence Transition Services during the referral process. <br><br>
  
  
  <strong>Wing Commander Ian Cumming, added:</strong><br><br>
  
  
  “We look forward to working with these partners to deliver the best opportunities to our veterans, and we would encourage any business that would like to support us with this project to get in touch.” <br><br>
  
  
  This accommodation offers a maximum two-year tenancy and is open to veterans of working age from throughout the UK. Any veterans interested in finding out more, or businesses looking to support the project, can contact: Tracy Higgins, Accommodation Manager on: 0141 814 4578 or accommodation@erskine.org.uk.<br>
...
<h1 style="text-align:center; margin-top: -155px; font-family:Montserrat sans-serif;">More News</h1>
<h1 style="text-align:center; margin-top: -30px ;font-family:Montserrat sans-serif;">_____________</h1>
<div class="row_news">
	<div class="column">
   <div class="card_news">
     <img src="../images/IMAGES Important/related_image4.jpg" alt="Volunteering" style="width:100%; border-top-left-radius:9px; border-top-right-radius:9px">
     <div class="container">
       <h3>Charities launch initiative to support volunteering</h3>
       <p class="title"></p>
       <p>Eighteen major charities have today pledged to work together on an initiative intended to share knowledge and skills...</p>
       <p></p>
       <a button class="button" href="../news/volunteers.php" > Read more </button></a>
     </div>
   </div>
 </div>
	...
	<div class="column">
  <div class="card_news">
    <img src="../images/IMAGES Important/gamer_streaming.jfif" alt="Refugee" style="width:100%; border-top-left-radius:9px; border-top-right-radius:9px">
    <div class="container">
      <h3>Gamers rally behind indie charity bundle</h3>
      <p class="title"></p>
      <p>A Palestinian software developer’s work is used to raise money to support people trapped in Gaza’s humanitarian crisis....</p>
      <p></p>
      <a button class="button" href="../news/gaming_charity.php" > Read more </button></a>
    </div>
  </div>
</div>
...
<div class="column">
	<div class="card_news">
			<img src="../images/IMAGES Important/related_image2.jpg" alt="Healthcare" style="width:100%; border-top-left-radius:9px; border-top-right-radius:9px">
			<div class="container">
					<h3>Erskine opens £4m residential centre for vets</h3>
					<p class="title"></p>
					<p>SCOTLAND’S veteran’s charity, Erskine, has opened the new David Boyle Court to provide accommodation and...</p>
					<p></p>
					<a button class="button" href="../news/vets.php" > Read more </button></a>
			</div>
	</div>
</div>
...
.post {
	...
	box-shadow: 0 1.4rem 8rem rgba(0, 0, 0, 0.5);
	position: relative;
	display: block;
	top: 120px;
...
.container::after, .row_news::after {
  content: "";
  clear: both;
  display: table;
}
...
.button:hover {
  background-color: rgb(113, 134, 148);
		color: #000;
}
