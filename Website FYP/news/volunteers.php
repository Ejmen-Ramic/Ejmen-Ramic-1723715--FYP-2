...
<center>
<div class="post">
	<h4 style="float: left;"> 12/10/2021 </h4>
	<div class="post_title"><h1 style="text-align: center; margin-top: 69px;"> Major charities launch initiative to  <br> support volunteering post-Covid-19 </h1></div>
	<br>
    <div class="post_description"> The Shaping the Future with Volunteering group aims to capitalise on the uptick in volunteering during the pandemic.</div>
	<div class="post_image">
		<img src="../images/IMAGES Important/related_image4.jpg "style="width:100%" >
</div>
	<div class="post_text">Eighteen major charities have today pledged to work together on an initiative intended to share knowledge and skills and make volunteering easier for people.<br><br>


  The aim of the Shaping the Future with Volunteering group, which includes the British Red Cross, National Trust and the RNLI, is to capitalise on the 'revolution' that has taken place in volunteering during the Covid-19 pandemic.<br><br>
  
  
  A total of 12.4 million people gave their time last year, compared with eight to nine million annually pre-Covid-19, and the group hopes to make the experience easier and encourage more people to keep volunteering.<br><br>
  
  
  A secretariat led by the Royal Voluntary Service will oversee the initiative, aided by a £50,000 fund provided by charities involved.<br><br>
  
  
  Catherine Johnstone, chief executive of RVS, and Matt Hyde, chief executive of The Scouts, will co-chair the group. All the chief executives will meet regularly.<br><br>
  
  
  Johnstone said Covid-19 had caused a “volunteering revolution” and charities “need to get our houses in order” to make the most of the “once-in-a-generation opportunity”.<br><br>
  
  
  She said many volunteers still felt they had to “jump through a million hoops” to give their time and the group would attempt to tackle this, as well as share systems and processes to disseminate best practice.<br><br>
  ...
  “It's a coalition of the willing. It's not an exclusive club. Others will be able to join.”<br><br>
...
<div class="row_news">
	...
	<div class="column">
		<div class="card_news">
				<img src="../images/IMAGES Important/related_image1.jpg" alt="Healthcare" style="width:100%; border-top-left-radius:9px; border-top-right-radius:9px">
				<div class="container">
						<h3>New guide will help charities strengthen partnerships</h3>
						<p class="title"></p>
						<p>THE new guide from Ecclesiastical Insurance Group explores lessons from the pandemic and will help charities develop stronger...</p>
						<p></p>
						<a button class="button" href="../news/laptop.php" > Read more </button></a>
				</div>
		</div>
</div>
...
<div class="column">
	<div class="card_news">
			<img src="../images/IMAGES Important/2e2a49_affa8a562a094e7488061e09e7f9a057_mv2.webp" alt="Healthcare" style="width:100%; border-top-left-radius:9px; border-top-right-radius:9px">
			<div class="container">
					<h3>New guide will help charities strengthen partnerships</h3>
					<p class="title"></p>
					<p>THE new guide from Ecclesiastical Insurance Group explores lessons from the pandemic and will help charities develop stronger...</p>
